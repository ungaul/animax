...
$('a[href="/v1/demon-slayer/"]')[2].innerHTML = "<div class='object active'> Demon Slayer </div>";

$("#previous-ep")[0].href = Number(pageNumber) - 1 + ".html";
$("#next-ep")[0].href = Number(pageNumber) + 1 + ".html";

$("#en-sub")[0].src = "/assets/streaming-files/voir-animes/demon-slayer/sub/" + season + pageNumber + "-en.vtt";
$("#fr-sub")[0].src = "/assets/streaming-files/voir-animes/demon-slayer/sub/" + season + pageNumber + "-fr.vtt";
