...
$('a[href="/v1/assassination-classroom/"]')[2].innerHTML = "<div class='object active'> Assassination Classroom </div>";

$("#previous-ep")[0].href = Number(pageNumber) - 1 + ".html";
$("#next-ep")[0].href = Number(pageNumber) + 1 + ".html";

$("#en-sub")[0].src = "/assets/streaming-files/voir-animes/assassination-classroom/sub/" + season + pageNumber + "-en.vtt";
$("#fr-sub")[0].src = "/assets/streaming-files/voir-animes/assassination-classroom/sub/" + season + pageNumber + "-fr.vtt";
