...
$('a[href="/v1/voir-animes/hunter-x-hunter/"]')[2].innerHTML = "<div class='object active'> Hunter × Hunter </div>";

$("#previous-ep")[0].href = Number(pageNumber) - 1 + ".html";
$("#next-ep")[0].href = Number(pageNumber) + 1 + ".html";

$("#en-sub")[0].src = "/assets/streaming-files/voir-animes/hunter-x-hunter/sub/" + season + pageNumber + "-en.vtt";
$("#fr-sub")[0].src = "/assets/streaming-files/voir-animes/hunter-x-hunter/sub/" + season + pageNumber + "-fr.vtt";
...
if (seasonLessSlash === "anime") {
  ...
  if (pageNumber === "148") {
    $("#next-ep")[0].innerHTML = "<button>Films <ion-icon name='chevron-forward-outline'></ion-icon></button>";
...
if (seasonLessSlash === "movies") {
  ...
  if (pageNumber === "1") {
    $("#previous-ep")[0].innerHTML = "<button><ion-icon name='chevron-back-outline'></ion-icon> Épisodes</button>";
    $("#previous-ep")[0].href = "../anime/";
  }

  if (pageNumber === "2") {
    $("#next-ep")[0].innerHTML = "<button class='locked'>Film Suivant <ion-icon name='chevron-forward-outline'></ion-icon></button>";
