...
$('a[href="/v1/voir-animes/my-hero-academia/"]')[2].innerHTML = "<div class='object active'> My Hero Academia </div>";

$("#previous-ep")[0].href = Number(pageNumber) - 1 + ".html";
$("#next-ep")[0].href = Number(pageNumber) + 1 + ".html";

$("#en-sub")[0].src = "/assets/streaming-files/voir-animes/my-hero-academia/sub/" + season + pageNumber + "-en.vtt";
$("#fr-sub")[0].src = "/assets/streaming-files/voir-animes/my-hero-academia/sub/" + season + pageNumber + "-fr.vtt";
