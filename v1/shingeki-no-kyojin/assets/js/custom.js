...
season = url.slice(38, -6);

animeName = "Shingeki No Kyojin";
$(".title")[0].innerHTML = animeName;
document.title = animeName + " - VoirAnimes";

$('a[href="/v1/voir-animes/shingeki-no-kyojin/"]')[2].innerHTML = "<div class='object active'> Shingeki No Kyojin </div>";

$("#previous-ep")[0].href = Number(pageNumber) - 1 + ".html";
$("#next-ep")[0].href = Number(pageNumber) + 1 + ".html";

$("#en-sub")[0].src = "/assets/streaming-files/voir-animes/shingeki-no-kyojin/sub/" + season + pageNumber + "-en.vtt";
$("#fr-sub")[0].src = "/assets/streaming-files/voir-animes/shingeki-no-kyojin/sub/" + season + pageNumber + "-fr.vtt";
