...
$('a[href="/v1/voir-animes/my-dress-up-darling/"]')[2].innerHTML =
...
$("#en-sub")[0].src = "/assets/streaming-files/voir-animes/my-dress-up-darling/sub/" + pageNumber + "-en.vtt";
$("#fr-sub")[0].src = "/assets/streaming-files/voir-animes/my-dress-up-darling/sub/" + pageNumber + "-fr.vtt";
