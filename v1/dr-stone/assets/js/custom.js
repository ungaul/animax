...
$("#en-sub")[0].src = "/assets/streaming-files/voir-animes/dr-stone/sub/" + season + pageNumber + "-en.vtt";
$("#fr-sub")[0].src = "/assets/streaming-files/voir-animes/dr-stone/sub/" + season + pageNumber + "-fr.vtt";
