...
$('a[href="/v1/blend-s/"]')[2].innerHTML = "<div class='object active'> Blend S </div>";
...
$("#en-sub")[0].src = "/assets/streaming-files/voir-animes/blend-s/sub/" + pageNumber + "-en.vtt";
$("#fr-sub")[0].src = "/assets/streaming-files/voir-animes/blend-s/sub/" + pageNumber + "-fr.vtt";
