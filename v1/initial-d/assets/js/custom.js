...
$('a[href="/v1/voir-animes/initial-d/"]')[2].innerHTML = "<div class='object active'> Initial D </div>";
...
try {
  $.ajax({
    url: "/assets/streaming-files/voir-animes/initial-d/sub" + season + pageNumber + "-fr.vtt",
    type: "HEAD",
    error: function () {
      console.log("Les sous titres sont incrustes");
    },
    success: function () {
      $("#fr-sub")[0].src = "/assets/streaming-files/voir-animes/initial-d/sub" + season + pageNumber + "-fr.vtt";
    },
  });
} catch (e) {}
...
try {
  $.ajax({
    url: "/assets/streaming-files/voir-animes/initial-d/sub" + season + pageNumber + "-en.vtt",
    type: "HEAD",
    error: function () {
      console.log("Les sous titres sont incrustes");
    },
    success: function () {
      $("#en-sub")[0].src = "/assets/streaming-files/voir-animes/initial-d/sub" + season + pageNumber + "-en.vtt";
    },
  });
} catch (e) {}
...
if (seasonLessSlash === "1-first-stage") {
  ...
  $("video")[0].src = episodesS1[pageNumber] + "?wrap=0";
  if (pageNumber === "1") {
